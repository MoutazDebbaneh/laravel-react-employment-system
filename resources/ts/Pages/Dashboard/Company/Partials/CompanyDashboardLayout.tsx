...
import UserDashboardLinks from "./CompanyDashboardLinks";
import CompanyDashboardLinks from "./CompanyDashboardLinks";
            ...
            >
                <FluidContainer className="border-t -mt-5 bg-[#F5F7FC] h-full min-h-screen">
                    <div className="sidebar-container flex flex-row relative h-full">
                        <div className="flex flex-col bg-white h-full w-fit md:w-64 absoulte start-0 !min-h-screen">
